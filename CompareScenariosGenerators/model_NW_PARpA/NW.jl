...
path_NW = string(raw"C:\Users\brigatto\Documents\GitHub\InflowForecastBias_Data\CompareScenariosGenerators\model_NW_PARpA\decks\Parp-A\\",year(last_date + Month(1)),"_",lpad(month(last_date + Month(1)), 2, "0"))
